...
| OPS-01 | Operations | Create one controlled job and follow it through Documentation, Transire, Shipping, Terminal, Pullout, and submitted lists | In progress | 2026-09-01: `E2EL260901` was verified and is active in the intended parallel Documentation, Transire, Shipping, and Terminal workspaces. Pull-Out is correctly unavailable until Terminal/TDO is released. Submitted-list and release checks remain pending. |
| OPS-02 | Stage isolation | Verify each stage retains its own owner, expected date, actual date, and notes | In progress | 2026-09-01: Dedicated workspaces retained distinct owners: Documentation `E2E Documentation Owner`, Transire `E2E Transire Owner`, Shipping `E2E Shipping Owner`, and Terminal `E2E Terminal Owner`. The date inputs could not be committed through the current browser driver despite showing a value; this needs manual-browser confirmation. The Operations detail generic control failed to retain its values and is logged as OPS-001. |
