...
const SHIPPING_LINES: Record<string, ShippingLineInfo> = {
  ...
  MSBU: { name: "MSC", shortName: "MSC", trackingUrl: (n) => `https://www.msc.com/en/search-a-shipment?agencyPath=nga&searchInfo=${n}`, isMaersk: false },
  MSDU: { name: "MSC", shortName: "MSC", trackingUrl: (n) => `https://www.msc.com/en/search-a-shipment?agencyPath=nga&searchInfo=${n}`, isMaersk: false },
  MSPU: { name: "MSC", shortName: "MSC", trackingUrl: (n) => `https://www.msc.com/en/search-a-shipment?agencyPath=nga&searchInfo=${n}`, isMaersk: false },
  MSNU: { name: "MSC", shortName: "MSC", trackingUrl: (n) => `https://www.msc.com/en/search-a-shipment?agencyPath=nga&searchInfo=${n}`, isMaersk: false },
  ...
  SEKU: { name: "MSC", shortName: "MSC", trackingUrl: (n) => `https://www.msc.com/en/search-a-shipment?agencyPath=nga&searchInfo=${n}`, isMaersk: false },
  TLLU: { name: "MSC", shortName: "MSC", trackingUrl: (n) => `https://www.msc.com/en/search-a-shipment?agencyPath=nga&searchInfo=${n}`, isMaersk: false },
  TEXU: { name: "MSC", shortName: "MSC", trackingUrl: (n) => `https://www.msc.com/en/search-a-shipment?agencyPath=nga&searchInfo=${n}`, isMaersk: false },
  BMOU: { name: "MSC", shortName: "MSC", trackingUrl: (n) => `https://www.msc.com/en/search-a-shipment?agencyPath=nga&searchInfo=${n}`, isMaersk: false },
  CAIU: { name: "MSC", shortName: "MSC", trackingUrl: (n) => `https://www.msc.com/en/search-a-shipment?agencyPath=nga&searchInfo=${n}`, isMaersk: false },
  CRXU: { name: "MSC", shortName: "MSC", trackingUrl: (n) => `https://www.msc.com/en/search-a-shipment?agencyPath=nga&searchInfo=${n}`, isMaersk: false },
  FSCU: { name: "MSC", shortName: "MSC", trackingUrl: (n) => `https://www.msc.com/en/search-a-shipment?agencyPath=nga&searchInfo=${n}`, isMaersk: false },
  TGHU: { name: "MSC", shortName: "MSC", trackingUrl: (n) => `https://www.msc.com/en/search-a-shipment?agencyPath=nga&searchInfo=${n}`, isMaersk: false },
  TCKU: { name: "MSC", shortName: "MSC", trackingUrl: (n) => `https://www.msc.com/en/search-a-shipment?agencyPath=nga&searchInfo=${n}`, isMaersk: false },
  GESU: { name: "MSC", shortName: "MSC", trackingUrl: (n) => `https://www.msc.com/en/search-a-shipment?agencyPath=nga&searchInfo=${n}`, isMaersk: false },
